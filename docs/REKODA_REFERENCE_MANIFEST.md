...
| Artifact                                                              | Role                                                                                                                     |
| --------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| `packages/db/migrations/0000`–`0151`                                  | The schema as it actually is; 150 files, contiguous                                                                      |
...
| 0018                                                                                          | Accepted; superseded in part by spec §3.2 and PR-087 (WABA catalogue order capture restored) |
| 0017                                                                                          | Accepted; scope narrowed by 0018                                                             |
| 0023                                                                                          | Accepted; interpreter model superseded by 0031                                               |
| All others (0003, 0006, 0010, 0011, 0015, 0016, 0019–0022, 0025, 0026, 0028, 0029, 0031–0034) | Accepted and current                                                                         |
