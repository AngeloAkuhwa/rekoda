...
| #                                                               | Title                                                                           | Status                                                      |
| --------------------------------------------------------------- | ------------------------------------------------------------------------------- | ----------------------------------------------------------- |
| [0001](0001-modular-monolith-typescript.md)                     | Modular monolith on TypeScript (NestJS + Next.js + Postgres)                    | Accepted (pg-boss replaced by 0022; STT sidecar by 0032)    |
...
| [0034](0034-the-operator-plane-has-identities-not-a-secret.md)  | The operator plane has identities, not a shared secret                          | Accepted                                                    |
