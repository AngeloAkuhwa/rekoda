...
distinction (MASTER-PLAN §1.3) is _exactly_ the fake-alert defence: a merchant
...
trustworthy _"no, that money has not arrived."_
...
gateway and AI router see such an image as _unstructured text at most_; it can
...
The mirror problem is forged _receipts_ — a document that looks like it came
...
accounting vocabulary, and it is the strongest possible answer to _"why should
I pay ₦9,900 a month?"_ — one prevented fake alert on a ₦50,000 sale pays for
five months.
...
**Marketing constraint:** say _"Rekoda confirms when money has actually
arrived in your account"_ — never _"Rekoda stops fraud."_ Rekoda cannot see a
