...
the verdict and findings; the trusted signer creates the sequence over
the complete existing role evidence, so re-posted old evidence never
supersedes newer evidence.
